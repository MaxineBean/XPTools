...
local function BaseHUDOne()
	...
	draw.RoundedBox( 0, 102, 14, math.Clamp((Maxwell.XP / Maxwell.XPReq * (ScreenW - 204)), 0, ScreenW - 204), 6, Color(20, 160, 20, 180) ) --Top, darker
	draw.RoundedBox( 0, 102, 20, math.Clamp((Maxwell.XP / Maxwell.XPReq * (ScreenW - 204)), 0, ScreenW - 204), 6, Color(20, 140, 20, 200) ) --Bot, lighter
...
local function BaseHUDTwo()
	...
	draw.RoundedBox( 0, 402, ScreenH - 16, math.Clamp((Maxwell.XP / Maxwell.XPReq * (ScreenW - 800)), 0, ScreenW - 804), 4, Color(20, 160, 20, 180) ) --Top, darker
	draw.RoundedBox( 0, 402, ScreenH - 12, math.Clamp((Maxwell.XP / Maxwell.XPReq * (ScreenW - 804)), 0, ScreenW - 804), 4, Color(20, 140, 20, 200) ) --Bot, lighter
